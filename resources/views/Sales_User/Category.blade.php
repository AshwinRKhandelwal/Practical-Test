                                            ...
                                            <table class="table">
                                                <thead class="bg-light">
                                                    <tr class="border-0">
                                                        ...
                                                        <th class="border-0">Category Image</th>
                                                ...
                                                @foreach ($Category as $list)
                                                    <tr>
                                                        ...
                                                        <td><img src="../uploads/Categoryimage/{{ $list->Category_image }}" width="100" height="100" class="user-image" title="{{ $list->Category_image }}" alt="User Image"> </td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <form id="Addcategoryform" >
                            ...
                            <div class="form-group row">
                              <label for="Category_image" class="col-md-4 col-form-label text-md-right">{{ __('Add Category Image') }}</label>
    ...
    <div class="modal-content">
      ...
      <form id="EditCategoryForm">
                     ...
                     <div class="form-group row">
                        ...
                        <div class="form-group row">
                          <label for="Editcategory_image" class="col-md-4 col-form-label text-md-right">{{ __('Add Category Image') }}</label>

                          <div class="col-md-6">
                              <input id="Editcategory_image" type="file" class="form-control" name="Editcategory_image" >
                              <span class="text-danger error-text Editcategory_image_error"></span>
                          </div>
                      </div>
