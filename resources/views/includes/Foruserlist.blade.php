    ...
    <div class="modal-content">
      ...
      <form id="EditUserForm">
                     ...
                     <div class="form-group row">
                                 <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Name') }}</label>
                                <div class="col-md-6">
                                  <input id="Editname" type="text" class="form-control @error('name') is-invalid @enderror" name="Editname"   autocomplete="name"  autofocus>
                         ...
                         <div class="form-group row">
                             <label for="email" class="col-md-4 col-form-label text-md-right">{{ __('E-Mail Address') }}</label>
                            <div class="col-md-6">
                              <input id="Editemail" type="email" class="form-control @error('email') is-invalid @enderror" name="Editemail"   autocomplete="email">
                    ...
                    @if(Auth::user()->role_id == 1||Auth::user()->role_id == 3)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="EditNumber" type="text" class="form-control @error('Number') is-invalid @enderror" name="EditNumber" >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="EditDesignation" type="text" class="form-control @error('Designation') is-invalid @enderror"  name="EditDesignation"  >
